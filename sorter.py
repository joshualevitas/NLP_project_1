...
# # sorting_categories = ["screenplay","director", "actress television series - comedy or musical", "foreign", "supporting actor", "actress supporting", "comedy musical", "actress comedy or musical", "mini series television", " original score","actress in a television series - drama", "actress in a motion picture","cecil b. demille award", "actor comedy or musical", "best drama","actor supporting series, mini television", " actress supporting motion picture", "television series - drama", " actor mini series television", "actress mini series television"," animated feature","original song"," drama", "television series comedy or musical","actor television series drama","actor television series comedy musical"]


# # stop_words = ['to', '-', 'the', 'in', 'not', 'too', 'best','motion','picture']
...
# # def category_guesser(twt_data, categories):
# #     #twt_data = [0, 0, ..., 2, 1, 0]
# #     threshold = .5
# #     ret = []
# #     ls = [len(cat.split()) for cat in categories]
# #     for cat in range(len(twt_data)):
# #         if twt_data[cat]/ls[cat] > threshold:
# #             ret.append(cat)
...
# #             for wd in tweet_tokenized:
                
# #                 if wd in categories[cat] and wd not in stop_words:
...
# #     for twt in range(len(ret)):
# #         guesses = category_guesser(ret[twt], categories)
# #         for guess in guesses:
# #             ret2[guess].append(twt)
# #     return ret2

# # # x = sorter(filepath, sorting_categories)
